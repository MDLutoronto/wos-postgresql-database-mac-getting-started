...
9. It may take a while to run, but when it is finished you will see the command prompt again, and now if you type `ls`from the Trillium prompt, you should see a new CSV file created from the Python script. Download the file ([as described earlier](#download)) and open up the file to see the results
...
**Date Created:** 2022\-02\-07**Updated:** 2025\-09\-11
